...
#define AppExeName "cuba-sdk.bat"
...
OutputBaseFilename=cuba-sdk-{#AppVersion}
...
[Messages]
FinishedLabelNoIcons=Setup has finished installing [name] on your computer. Open a terminal and run the cuba-sdk command to start.
