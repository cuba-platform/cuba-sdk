...
abstract class Nexus2SearchComponentProvider(framework: String) : BaseComponentProvider(framework) {
    ...
    override fun loadVersions(componentId: String): List<Option<String>> {
        ...
        if (split.size >= 2) {
            ...
            val result =
                sdkSettings.get("${framework}.artifact.base.url").plus("g=${groupId}&a=${artifactId}")
                    .httpGet()
