...
class Nexus2Search : RepositorySearch {

    private val log: Logger = Logger.getLogger(Nexus2Search::class.java.name)
    ...
    override fun search(component: Component): Component? {
        val (_, _, result) = searchContext.url
            ...
            .also {
                if (searchContext.login != null && searchContext.password != null) {
                    it.authentication()
                        .basic(searchContext.login, searchContext.password)
                }
            }
